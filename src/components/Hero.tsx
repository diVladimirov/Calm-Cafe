...
export default function Hero() {
  return (
    <section className="h-[80vh] xl:h-screen relative text-white">
      <div className="hero-overlay absolute w-full h-full z-10 bg-primary/[0.93]"></div>
      <video
        autoPlay
        loop
        muted
      ...
      <div className="container mx-auto px-4 h-full flex flex-col xl:flex-row items-center z-30 relative">
        <div
          data-scroll
